  ...
  return (
    <div className="p-6 md:p-8 space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {/* Total Revenue */}
        <Card className="shadow-sm hover:shadow-md transition-all duration-200 border border-border/60">
      ...
      <div className="grid gap-6 md:gap-8 lg:grid-cols-2 xl:grid-cols-3">
        {/* Transactions Card */}
        <Card className="xl:col-span-2 shadow-sm border border-orange-500/60">
          <CardHeader>
        ...
        {/* Recent Sales Card */}
        <Card className="shadow-sm border border-orange-500/60">
          <CardHeader>
