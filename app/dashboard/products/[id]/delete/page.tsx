      ...
      <Card className="w-full max-w-2xl shadow-xl rounded-2xl border border-orange-500/60">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-base text-gray-300">
            This action cannot be undone. Deleting this product will remove it permanently.
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="w-full flex justify-center gap-4 mt-6">
          ...
          <form action={deleteProduct}>
            ...
            <SubmitButton title="Delete" variant="destructive" className="px-6 py-2 rounded-lg" />
          </form>
        </CardFooter>
      </Card>
    </div>
